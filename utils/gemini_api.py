...
class GeminiAPIHandler:
    ...
    def process_video(self, video_path: str, model_name: str = None) -> str:
        ...
        try:
            ...
            반드시 SRT 형식으로만 응답해주세요. 설명이나 추가 텍스트 없이 순수한 SRT 형식의 자막만 반환해주세요.
            ...
            주의사항:
            1. 응답에는 SRT 형식의 자막만 포함해야 합니다.
            2. 어떠한 설명, 소개, 부가 설명도 포함하지 마세요.
            3. 처음과 끝에 추가 텍스트나 마크다운 코드 블록 등을 사용하지 마세요.
            4. 자막 번호, 타임스탬프, 대사만 정확하게 SRT 형식으로 작성해주세요.
            5. 빈 대사는 생성하지 말고, 실제 말하는 내용을 정확하게 받아 적어주세요.
            """
